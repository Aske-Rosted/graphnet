    ...
    def __call__(self, frame: "icetray.I3Frame") -> Dict[str, List[Any]]:
        ...
        for om_key in om_keys:
            ...
            r = phys_services.I3Calculator.closest_approach_distance(
                self._leading_particle, self._gcd_dict[om_key].position
            )
            c_t = (
                self._leading_particle.time
        ...
        reco_pulses_final.loc[
            (reco_pulses_final["timing_residual"] < 0)
            & (reco_pulses_final["timing_residual"] > -1000)
            & (reco_pulses_final["r"] < 500),
            "adjusted_time",
        ] = (
            reco_pulses_final["adjusted_time"]
            - reco_pulses_final["timing_residual"]
        )
