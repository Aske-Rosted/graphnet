...
class I3BundleEliminator(I3Extractor):
...
'''
Chain
-> Currently Eliminates All Resiudal Hits in Event
-> Slight Modification to Prevent Noise From Being Effected
'''
class I3BundleEliminatorIceCube86(I3BundleEliminator):
    ...
    def __call__(self, frame: "icetray.I3Frame") -> Dict[str, List[Any]]:
        ...
        # Get Leading Particle Information
        self._leading_particle = self._get_leading_particle(
            frame,
        )
        ...
        for om_key in om_keys:
            ...
            r = phys_services.I3Calculator.closest_approach_distance(self._leading_particle, self._gcd_dict[om_key].position)
            c_t = self._leading_particle.time + phys_services.I3Calculator.cherenkov_time(self._leading_particle,self._gcd_dict[om_key].position)
            ...
            for _,pulse in enumerate(pulses):
                ...
                output['r'].append(r)
                output['timing_residual'].append(pulse.time - c_t)
                minimum_residual = -2.822638158518*r
                output['timing_residual_min'] = minimum_residual
                output['cherenkov_time'] = c_t
        ...
        evt_pulses = pd.DataFrame( {"charge": output['charge'],
                                    ...
                                    "r": output['r'],
                                    "timing_residual": output['timing_residual'],
                                    "timing_residual_min": output['timing_residual_min'],
                                    "cherenkov_time": output['cherenkov_time'],
                                    },)
...
#
        ...
        reco_pulses_final.loc[(reco_pulses_final['timing_residual'] < 0) & (reco_pulses_final['timing_residual'] > -1000) & (reco_pulses_final['r'] < 500), 'adjusted_time'] = reco_pulses_final['adjusted_time'] - reco_pulses_final['timing_residual']
